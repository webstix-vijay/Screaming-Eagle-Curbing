        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-[#64748B] text-base leading-relaxed mb-8">
              Based in Holmen, Wisconsin, we provide{' '}
              <Link
                href="/services"
                className="text-[#1E3A8A] font-medium hover:text-[#0F172A] transition-colors"
              >
                decorative curbing and landscaping services
              </Link>{' '}
              throughout La Crosse County and the surrounding areas. If you are unsure whether
              ...
              . We are always happy to discuss your project.
            </p>
