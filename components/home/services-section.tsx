...
type HomeServiceCard = {
  ...
  href: string
  featured?: boolean
  /** Custom link label (defaults to "Explore {title}") */
  ctaText?: string
  /** CSS `object-position` for portrait photos in fixed-height cards */
  imageObjectPosition?: string
}

/** Fixed height for every card image so the grid stays aligned regardless of source aspect ratio */
const SERVICE_CARD_IMAGE_HEIGHT = 'h-52'
...
const services: HomeServiceCard[] = [
  ...
  },
  {
    ...
    title: 'Need Help?',
    description:
      'Have questions about curbing, rock & mulch, retaining walls, or other services? Contact our team and we’ll help you choose the best option for your property.',
    image: '/images/services/contact-support.png',
      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        >
          {services.map((service) => (
            ...
            >
              {/* Image */}
              <div className={`relative overflow-hidden ${SERVICE_CARD_IMAGE_HEIGHT}`}>
                <Image
                  src={service.image}
                  alt={service.title}
                  fill
              ...
              <div className="p-6">
                ...
                >
                  {service.ctaText ?? `Explore ${service.title}`}
