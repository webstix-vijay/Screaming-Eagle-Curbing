...
import { retainingWallsMetadata } from '@/lib/seo/pages'

export const metadata = retainingWallsMetadata
...
export default function RetainingWallsPage() {
  return (
    <ServicePageLayout
      ...
      servicePath="/services/retaining-walls"
      heroImage="/images/services/retaining-walls.png"
      heroImageObjectPosition="36% 52%"
      benefits={benefits}
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl">
              <Image
                src="/images/services/retaining-walls.png"
                alt="Professional retaining wall installation"
                fill
                className="object-cover"
                style={{ objectPosition: '36% 52%' }}
              />
            </div>
          </div>
