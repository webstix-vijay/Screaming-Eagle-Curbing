...
import { seedingMetadata } from '@/lib/seo/pages'

export const metadata = seedingMetadata
...
export default function SeedingPage() {
  return (
    <ServicePageLayout
      ...
      servicePath="/services/seeding"
      heroImage="/images/services/retaining-walls-seeding.png"
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl">
              <Image
                src="/images/services/retaining-walls-seeding.png"
