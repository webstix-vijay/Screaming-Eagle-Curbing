...
import { pickRelatedServices } from '@/lib/service-images'
import { IMAGE_SIZES } from '@/lib/seo/image-sizes'
import { decorativeCurbingMetadata } from '@/lib/seo/pages'

export const metadata = decorativeCurbingMetadata
...
export default function DecorativeCurbingPage() {
  return (
    <ServicePageLayout
      ...
      servicePath="/services/decorative-curbing"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl">
              <Image
                ...
                alt="Decorative curbing installation in La Crosse, WI"
                fill
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                <div className="relative aspect-[4/3]">
                  <Image
                    ...
                    alt="Standard decorative curb style"
                    fill
                    className="object-cover"
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                <div className="relative aspect-[4/3]">
                  <Image
                    ...
                    alt="Roller stamp decorative curb style"
                    fill
                    className="object-cover"
                    sizes={IMAGE_SIZES.card}
                    loading="lazy"
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                <div className="relative aspect-[4/3]">
                  <Image
                    ...
                    alt="Carved custom decorative curb style"
                    fill
                    className="object-cover"
                    sizes={IMAGE_SIZES.card}
                    loading="lazy"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl order-2 lg:order-1">
              <Image
                ...
                alt="Colored decorative curbing options"
                fill
                className="object-cover"
                sizes={IMAGE_SIZES.contentHalf}
                loading="lazy"
