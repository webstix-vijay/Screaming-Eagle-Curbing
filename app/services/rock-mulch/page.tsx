...
import { rockMulchMetadata } from '@/lib/seo/pages'

export const metadata = rockMulchMetadata
...
export default function RockMulchPage() {
  return (
    <ServicePageLayout
      ...
      servicePath="/services/rock-mulch"
      heroImage="/images/services/rock-mulch.png"
      heroImageObjectPosition="44% 48%"
      benefits={benefits}
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-xl">
              <Image
                src="/images/services/rock-mulch.png"
