...
export const aiPolicyMetadata = createPageMetadata({
  title: 'AI Policy',
  description:
    'Learn how Screaming Eagle Curbing uses artificial intelligence responsibly to support our website, customer communication, and landscaping services.',
  path: '/ai-policy',
})

export const serviceIndexMetadata = createPageMetadata({
  title: 'Service Index',
  description:
    'A complete index of decorative curbing and landscaping services offered by Screaming Eagle Curbing across La Crosse, Holmen, Onalaska, and the Coulee Region.',
  path: '/service-index',
})
